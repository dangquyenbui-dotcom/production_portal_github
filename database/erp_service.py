...
ADDED: Method to get detailed current month shipments.
"""
...
class ErpService:
    ...
    def get_detailed_shipments_current_month(self):
        """Delegates call to SalesQueries for detailed shipment data."""
        return self.sales_queries.get_detailed_shipments_current_month()
    # --- END NEW METHOD ---
